 ...
 * </p>
 * <ul>
 *   <li>{@link fashion.impl.EmergingBrandImpl#getCountries <em>Countries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmergingBrandImpl extends BrandImpl implements EmergingBrand {
	...
	protected EClass eStaticClass() {
		return FashionPackage.Literals.EMERGING_BRAND;
	}
	...
	public EList<String> getCountries() {
		if (countries == null) {
			countries = new EDataTypeUniqueEList<String>(String.class, this, FashionPackage.EMERGING_BRAND__COUNTRIES);
		}
		return countries;
	}
