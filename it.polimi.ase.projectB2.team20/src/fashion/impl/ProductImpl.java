 ...
 * </p>
 * <ul>
 *   <li>{@link fashion.impl.ProductImpl#getName <em>Name</em>}</li>
 *   <li>{@link fashion.impl.ProductImpl#getReviews <em>Reviews</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductImpl extends FashionElementImpl implements Product {
	...
	protected EClass eStaticClass() {
		return FashionPackage.Literals.PRODUCT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FashionPackage.PRODUCT__NAME, oldName, name));
	}
	...
	public EList<Review> getReviews() {
		if (reviews == null) {
			reviews = new EObjectWithInverseResolvingEList<Review>(Review.class, this, FashionPackage.PRODUCT__REVIEWS, FashionPackage.REVIEW__PRODUCT);
		}
		return reviews;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FashionPackage.PRODUCT__REVIEWS:
