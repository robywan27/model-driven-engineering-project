 ...
 * </p>
 * <ul>
 *   <li>{@link it.polimi.ase.projectB2.team20.xtext.fashionDsl.impl.MacroEventImpl#getCity <em>City</em>}</li>
 *   <li>{@link it.polimi.ase.projectB2.team20.xtext.fashionDsl.impl.MacroEventImpl#getSingleBrandEvents <em>Single Brand Events</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MacroEventImpl extends EventImpl implements MacroEvent
{
  ...
  {
    return FashionDslPackage.Literals.MACRO_EVENT;
  }
  ...
  public void setCity(String newCity)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FashionDslPackage.MACRO_EVENT__CITY, oldCity, city));
  }
  ...
  public EList<SingleBrandEvent> getSingleBrandEvents()
  {
    ...
    {
      singleBrandEvents = new EObjectContainmentEList<SingleBrandEvent>(SingleBrandEvent.class, this, FashionDslPackage.MACRO_EVENT__SINGLE_BRAND_EVENTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FashionDslPackage.MACRO_EVENT__SINGLE_BRAND_EVENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FashionDslPackage.MACRO_EVENT__CITY:
        return getCity();
      case FashionDslPackage.MACRO_EVENT__SINGLE_BRAND_EVENTS:
