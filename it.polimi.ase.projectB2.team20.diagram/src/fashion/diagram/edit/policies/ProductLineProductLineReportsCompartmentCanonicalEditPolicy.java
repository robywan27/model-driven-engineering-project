 ...
 * @generated
 */
public class ProductLineProductLineReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductLineProductLineReportsCompartment_7018SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductLineProductLineReportsCompartment_7018SemanticChildren((View) getHost()
						.getModel());
