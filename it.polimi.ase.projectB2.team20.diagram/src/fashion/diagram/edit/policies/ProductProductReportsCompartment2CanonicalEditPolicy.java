 ...
 * @generated
 */
public class ProductProductReportsCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductProductReportsCompartment_7020SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductProductReportsCompartment_7020SemanticChildren((View) getHost()
						.getModel());
