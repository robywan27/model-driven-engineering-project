 ...
 * @generated
 */
public class ProductLineProductLineProductsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return FashionPackage.eINSTANCE.getProductLine_Products();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductLineProductLineProductsCompartment_7028SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Product2EditPart.VISUAL_ID == FashionVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductLineProductLineProductsCompartment_7028SemanticChildren((View) getHost()
						.getModel());
