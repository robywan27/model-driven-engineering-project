 ...
 * @generated
 */
public class PhotoPhotoReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getPhotoPhotoReportsCompartment_7009SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getPhotoPhotoReportsCompartment_7009SemanticChildren((View) getHost()
						.getModel());
