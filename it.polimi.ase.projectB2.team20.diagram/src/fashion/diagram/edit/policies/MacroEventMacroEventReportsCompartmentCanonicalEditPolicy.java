 ...
 * @generated
 */
public class MacroEventMacroEventReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getMacroEventMacroEventReportsCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getMacroEventMacroEventReportsCompartment_7007SemanticChildren((View) getHost()
						.getModel());
