 ...
 * @generated
 */
public class AdvertisingCampaignAdvertisingCampaignReportsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return FashionPackage.eINSTANCE.getFashionElement_Reports();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingCampaignAdvertisingCampaignReportsCompartment_7017SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ArticleEditPart.VISUAL_ID
				|| visualID == TVProgramEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingCampaignAdvertisingCampaignReportsCompartment_7017SemanticChildren((View) getHost()
						.getModel());
