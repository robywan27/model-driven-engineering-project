 ...
 * @generated
 */
public class ProductStyleProductStyleReportsCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductStyleProductStyleReportsCompartment_7019SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductStyleProductStyleReportsCompartment_7019SemanticChildren((View) getHost()
						.getModel());
