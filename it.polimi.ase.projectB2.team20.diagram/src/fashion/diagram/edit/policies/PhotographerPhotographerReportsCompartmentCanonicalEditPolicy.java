 ...
 * @generated
 */
public class PhotographerPhotographerReportsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getPhotographerPhotographerReportsCompartment_7016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getPhotographerPhotographerReportsCompartment_7016SemanticChildren((View) getHost()
						.getModel());
