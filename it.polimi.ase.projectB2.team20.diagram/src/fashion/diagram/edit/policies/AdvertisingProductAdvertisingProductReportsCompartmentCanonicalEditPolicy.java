 ...
 * @generated
 */
public class AdvertisingProductAdvertisingProductReportsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingProductAdvertisingProductReportsCompartment_7025SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingProductAdvertisingProductReportsCompartment_7025SemanticChildren((View) getHost()
						.getModel());
