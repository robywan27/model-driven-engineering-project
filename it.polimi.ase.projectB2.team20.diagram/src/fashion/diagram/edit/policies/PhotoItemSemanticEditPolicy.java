...
import fashion.diagram.edit.commands.ReviewReviewerCreateCommand;
import fashion.diagram.edit.commands.ReviewReviewerReorientCommand;
import fashion.diagram.edit.commands.ReviewerReviewsCreateCommand;
import fashion.diagram.edit.commands.ReviewerReviewsReorientCommand;
 ...
 * @generated
 */
public class PhotoItemSemanticEditPolicy extends
		FashionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public PhotoItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (FashionVisualIDRegistry.getVisualID(incomingLink) == ProductReviewsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (FashionVisualIDRegistry.getVisualID(incomingLink) == ReviewerReviewsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (FashionVisualIDRegistry.getVisualID(outgoingLink) == ReviewProductEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (FashionVisualIDRegistry.getVisualID(outgoingLink) == ReviewReviewerEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (FashionElementTypes.ReviewReviewer_4013 == req.getElementType()) {
			return getGEFWrapper(new ReviewReviewerCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (FashionElementTypes.ReviewerReviews_4016 == req.getElementType()) {
			return null;
		}
		return null;
	}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (FashionElementTypes.ReviewerReviews_4016 == req.getElementType()) {
			return getGEFWrapper(new ReviewerReviewsCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case ReviewReviewerEditPart.VISUAL_ID:
			return getGEFWrapper(new ReviewReviewerReorientCommand(req));
		case ReviewerReviewsEditPart.VISUAL_ID:
			return getGEFWrapper(new ReviewerReviewsReorientCommand(req));
		}
