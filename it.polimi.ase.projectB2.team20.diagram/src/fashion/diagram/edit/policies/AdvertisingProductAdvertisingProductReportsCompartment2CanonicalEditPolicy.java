 ...
 * @generated
 */
public class AdvertisingProductAdvertisingProductReportsCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingProductAdvertisingProductReportsCompartment_7026SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingProductAdvertisingProductReportsCompartment_7026SemanticChildren((View) getHost()
						.getModel());
