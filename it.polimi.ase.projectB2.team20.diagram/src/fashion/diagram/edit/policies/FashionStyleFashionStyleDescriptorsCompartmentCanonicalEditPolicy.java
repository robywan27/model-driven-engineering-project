 ...
 * @generated
 */
public class FashionStyleFashionStyleDescriptorsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return FashionPackage.eINSTANCE.getFashionStyle_Descriptors();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getFashionStyleFashionStyleDescriptorsCompartment_7021SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SpatioTemporalDescriptorEditPart.VISUAL_ID == FashionVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getFashionStyleFashionStyleDescriptorsCompartment_7021SemanticChildren((View) getHost()
						.getModel());
