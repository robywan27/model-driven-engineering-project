 ...
 * @generated
 */
public class ChoreographerChoreographerReportsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getChoreographerChoreographerReportsCompartment_7015SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getChoreographerChoreographerReportsCompartment_7015SemanticChildren((View) getHost()
						.getModel());
