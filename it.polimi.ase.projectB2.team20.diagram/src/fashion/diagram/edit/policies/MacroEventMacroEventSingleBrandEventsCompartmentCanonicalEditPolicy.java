 ...
 * @generated
 */
public class MacroEventMacroEventSingleBrandEventsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return FashionPackage.eINSTANCE.getMacroEvent_SingleBrandEvents();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getMacroEventMacroEventSingleBrandEventsCompartment_7023SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SingleBrandEvent2EditPart.VISUAL_ID == FashionVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getMacroEventMacroEventSingleBrandEventsCompartment_7023SemanticChildren((View) getHost()
						.getModel());
