 ...
 * @generated
 */
public class DesignerDesignerReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getDesignerDesignerReportsCompartment_7012SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getDesignerDesignerReportsCompartment_7012SemanticChildren((View) getHost()
						.getModel());
