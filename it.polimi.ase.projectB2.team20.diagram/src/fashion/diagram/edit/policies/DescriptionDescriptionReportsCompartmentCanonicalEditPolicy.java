 ...
 * @generated
 */
public class DescriptionDescriptionReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getDescriptionDescriptionReportsCompartment_7010SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getDescriptionDescriptionReportsCompartment_7010SemanticChildren((View) getHost()
						.getModel());
