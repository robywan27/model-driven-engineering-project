 ...
 * @generated
 */
public class CriticCriticReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getCriticCriticReportsCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getCriticCriticReportsCompartment_7002SemanticChildren((View) getHost()
						.getModel());
