 ...
 * @generated
 */
public class BloggerBloggerReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getBloggerBloggerReportsCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getBloggerBloggerReportsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
