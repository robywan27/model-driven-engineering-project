 ...
 * @generated
 */
public class ProductStyleProductStyleReportsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductStyleProductStyleReportsCompartment_7029SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductStyleProductStyleReportsCompartment_7029SemanticChildren((View) getHost()
						.getModel());
