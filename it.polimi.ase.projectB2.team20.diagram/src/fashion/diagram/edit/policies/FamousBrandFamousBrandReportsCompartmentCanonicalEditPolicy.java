 ...
 * @generated
 */
public class FamousBrandFamousBrandReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getFamousBrandFamousBrandReportsCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getFamousBrandFamousBrandReportsCompartment_7004SemanticChildren((View) getHost()
						.getModel());
