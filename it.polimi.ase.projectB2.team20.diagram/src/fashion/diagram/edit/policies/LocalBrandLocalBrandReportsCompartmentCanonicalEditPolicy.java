 ...
 * @generated
 */
public class LocalBrandLocalBrandReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getLocalBrandLocalBrandReportsCompartment_7006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getLocalBrandLocalBrandReportsCompartment_7006SemanticChildren((View) getHost()
						.getModel());
