 ...
 * @generated
 */
public class SingleBrandEvent2ItemSemanticEditPolicy extends
		FashionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SingleBrandEvent2ItemSemanticEditPolicy() {
		super(FashionElementTypes.SingleBrandEvent_3005);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (FashionVisualIDRegistry.getVisualID(outgoingLink) == SingleBrandEventBrandEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
