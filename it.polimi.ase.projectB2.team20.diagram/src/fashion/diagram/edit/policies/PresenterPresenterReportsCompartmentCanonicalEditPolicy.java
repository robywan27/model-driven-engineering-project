 ...
 * @generated
 */
public class PresenterPresenterReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getPresenterPresenterReportsCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getPresenterPresenterReportsCompartment_7014SemanticChildren((View) getHost()
						.getModel());
