 ...
 * @generated
 */
public class SingleBrandEventSingleBrandEventReportsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getSingleBrandEventSingleBrandEventReportsCompartment_7024SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getSingleBrandEventSingleBrandEventReportsCompartment_7024SemanticChildren((View) getHost()
						.getModel());
