 ...
 * @generated
 */
public class TVProgramItemSemanticEditPolicy extends
		FashionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TVProgramItemSemanticEditPolicy() {
		super(FashionElementTypes.TVProgram_3002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (FashionVisualIDRegistry.getVisualID(outgoingLink) == NewsReportElementsEditPart.VISUAL_ID) {
