 ...
 * @generated
 */
public class InfluencerInfluencerReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getInfluencerInfluencerReportsCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getInfluencerInfluencerReportsCompartment_7003SemanticChildren((View) getHost()
						.getModel());
