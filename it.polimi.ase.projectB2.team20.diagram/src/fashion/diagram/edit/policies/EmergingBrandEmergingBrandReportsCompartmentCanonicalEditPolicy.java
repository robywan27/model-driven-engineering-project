 ...
 * @generated
 */
public class EmergingBrandEmergingBrandReportsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getEmergingBrandEmergingBrandReportsCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getEmergingBrandEmergingBrandReportsCompartment_7005SemanticChildren((View) getHost()
						.getModel());
