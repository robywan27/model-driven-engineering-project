 ...
 * @generated
 */
public class CommentCommentReportsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getCommentCommentReportsCompartment_7011SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getCommentCommentReportsCompartment_7011SemanticChildren((View) getHost()
						.getModel());
