 ...
 * @generated
 */
public class ProductLineProductLineProductStylesCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return FashionPackage.eINSTANCE.getProductLine_ProductStyles();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductLineProductLineProductStylesCompartment_7027SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ProductStyle2EditPart.VISUAL_ID == FashionVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getProductLineProductLineProductStylesCompartment_7027SemanticChildren((View) getHost()
						.getModel());
