 ...
 * @generated
 */
public class SingleBrandEventSingleBrandEventReportsCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getSingleBrandEventSingleBrandEventReportsCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getSingleBrandEventSingleBrandEventReportsCompartment_7008SemanticChildren((View) getHost()
						.getModel());
