 ...
 * @generated
 */
public class AdvertisingCampaignAdvertisingCampaignProductsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return FashionPackage.eINSTANCE.getAdvertisingCampaign_Products();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingCampaignAdvertisingCampaignProductsCompartment_7022SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return AdvertisingProduct2EditPart.VISUAL_ID == FashionVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<FashionNodeDescriptor> childDescriptors = FashionDiagramUpdater
				.getAdvertisingCampaignAdvertisingCampaignProductsCompartment_7022SemanticChildren((View) getHost()
						.getModel());
