 ...
 * @generated
 */
public class FashionCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public FashionCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", FashionDomainEditPart.MODEL_ID); //$NON-NLS-1$
