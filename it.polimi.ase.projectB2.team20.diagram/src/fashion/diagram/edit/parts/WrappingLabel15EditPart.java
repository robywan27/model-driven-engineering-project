...
public class WrappingLabel15EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				FashionVisualIDRegistry
						.getType(fashion.diagram.edit.parts.WrappingLabel15EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FashionParserProvider.getParser(
					FashionElementTypes.DesignerBrand_4015, getParserElement(),
