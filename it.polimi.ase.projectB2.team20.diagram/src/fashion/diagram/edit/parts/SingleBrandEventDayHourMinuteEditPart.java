 ...
 * @generated
 */
public class SingleBrandEventDayHourMinuteEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SingleBrandEventDayHourMinuteEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.SingleBrandEventDayHourMinuteEditPart.VISUAL_ID));
		}
		return parser;
	}
