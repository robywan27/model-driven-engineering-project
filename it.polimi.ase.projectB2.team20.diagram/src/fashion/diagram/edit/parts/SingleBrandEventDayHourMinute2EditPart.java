 ...
 * @generated
 */
public class SingleBrandEventDayHourMinute2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SingleBrandEventDayHourMinute2EditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.SingleBrandEventDayHourMinute2EditPart.VISUAL_ID));
		}
		return parser;
	}
