 ...
 * @generated
 */
public class PhotoTagsEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PhotoTagsEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.PhotoTagsEditPart.VISUAL_ID));
		}
		return parser;
	}
