 ...
 * @generated
 */
public class ArticleTypeMagazineEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArticleTypeMagazineEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.ArticleTypeMagazineEditPart.VISUAL_ID));
		}
		return parser;
	}
