 ...
 * @generated
 */
public class AdvertisingProductNameTypeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AdvertisingProductNameTypeEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.AdvertisingProductNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
