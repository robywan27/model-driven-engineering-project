 ...
 * @generated
 */
public class SpatioTemporalDescriptorPeriodLocationEditPart extends
	 ...
	 * @generated
	 */
	public SpatioTemporalDescriptorPeriodLocationEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.SpatioTemporalDescriptorPeriodLocationEditPart.VISUAL_ID));
		}
		return parser;
	}
