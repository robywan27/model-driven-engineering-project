 ...
 * @generated
 */
public class TVProgramNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TVProgramNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.TVProgramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
