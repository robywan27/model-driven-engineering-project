 ...
 * @generated
 */
public class DescriptionIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DescriptionIdEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.DescriptionIdEditPart.VISUAL_ID));
		}
		return parser;
	}
