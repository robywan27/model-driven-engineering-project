 ...
 * @generated
 */
public class FamousBrandNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FamousBrandNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.FamousBrandNameEditPart.VISUAL_ID));
		}
		return parser;
	}
