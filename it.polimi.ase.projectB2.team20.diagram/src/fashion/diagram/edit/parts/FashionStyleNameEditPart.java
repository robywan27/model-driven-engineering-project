 ...
 * @generated
 */
public class FashionStyleNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FashionStyleNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.FashionStyleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
