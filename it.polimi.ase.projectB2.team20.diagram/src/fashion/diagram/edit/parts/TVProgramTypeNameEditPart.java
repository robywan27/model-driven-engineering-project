 ...
 * @generated
 */
public class TVProgramTypeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TVProgramTypeNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.TVProgramTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
