 ...
 * @generated
 */
public class PhotographerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PhotographerNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.PhotographerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
