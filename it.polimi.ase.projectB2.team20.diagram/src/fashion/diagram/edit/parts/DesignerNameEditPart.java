 ...
 * @generated
 */
public class DesignerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DesignerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FashionParserProvider
					.getParser(
							FashionElementTypes.Designer_2012,
							getParserElement(),
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.DesignerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
