...
import fashion.diagram.edit.policies.FashionTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SingleBrandEventNameYearMonthDayHourMin2EditPart extends
	 ...
	 * @generated
	 */
	public SingleBrandEventNameYearMonthDayHourMin2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new FashionTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return FashionElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FashionParserProvider
					.getParser(
							FashionElementTypes.SingleBrandEvent_3005,
							getParserElement(),
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.SingleBrandEventNameYearMonthDayHourMin2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					FashionEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
