 ...
 * @generated
 */
public class AdvertisingCampaignNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AdvertisingCampaignNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.AdvertisingCampaignNameEditPart.VISUAL_ID));
		}
		return parser;
	}
