 ...
 * @generated
 */
public class ChoreographerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ChoreographerNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.ChoreographerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
