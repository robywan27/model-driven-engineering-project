 ...
 * @generated
 */
public class MacroEventNameYearMonthCityEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MacroEventNameYearMonthCityEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.MacroEventNameYearMonthCityEditPart.VISUAL_ID));
		}
		return parser;
	}
