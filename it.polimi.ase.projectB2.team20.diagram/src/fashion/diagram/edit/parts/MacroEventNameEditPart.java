 ...
 * @generated
 */
public class MacroEventNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MacroEventNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.MacroEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
