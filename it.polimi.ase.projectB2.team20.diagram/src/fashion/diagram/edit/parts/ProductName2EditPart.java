 ...
 * @generated
 */
public class ProductName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProductName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FashionParserProvider
					.getParser(
							FashionElementTypes.Product_3007,
							getParserElement(),
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.ProductName2EditPart.VISUAL_ID));
		}
		return parser;
	}
