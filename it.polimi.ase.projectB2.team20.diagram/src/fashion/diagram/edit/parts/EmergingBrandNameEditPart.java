 ...
 * @generated
 */
public class EmergingBrandNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EmergingBrandNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.EmergingBrandNameEditPart.VISUAL_ID));
		}
		return parser;
	}
