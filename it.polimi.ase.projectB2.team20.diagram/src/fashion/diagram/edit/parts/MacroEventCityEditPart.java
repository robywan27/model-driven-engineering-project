 ...
 * @generated
 */
public class MacroEventCityEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MacroEventCityEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.MacroEventCityEditPart.VISUAL_ID));
		}
		return parser;
	}
