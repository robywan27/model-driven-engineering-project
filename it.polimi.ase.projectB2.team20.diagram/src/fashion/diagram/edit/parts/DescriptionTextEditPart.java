 ...
 * @generated
 */
public class DescriptionTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DescriptionTextEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.DescriptionTextEditPart.VISUAL_ID));
		}
		return parser;
	}
