 ...
 * @generated
 */
public class SingleBrandEventNameYearMonthDayHourMinEditPart extends
	 ...
	 * @generated
	 */
	public SingleBrandEventNameYearMonthDayHourMinEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.SingleBrandEventNameYearMonthDayHourMinEditPart.VISUAL_ID));
		}
		return parser;
	}
