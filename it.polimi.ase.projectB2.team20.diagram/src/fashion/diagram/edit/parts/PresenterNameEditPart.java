 ...
 * @generated
 */
public class PresenterNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PresenterNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.PresenterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
