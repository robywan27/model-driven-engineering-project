...
import fashion.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ModelModelReportsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getModelReportsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ModelModelReportsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ModelModelReportsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getModelReportsCompartmentFigure();
			pane.remove(((ModelModelReportsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ModelModelReportsCompartmentEditPart) {
			return getPrimaryShape().getModelReportsCompartmentFigure();
		}
	...
	public class ModelFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fModelReportsCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureModelLabelFigure.setMaximumSize(new Dimension(getMapMode()
					.DPtoLP(10000), getMapMode().DPtoLP(50)));

			this.add(fFigureModelLabelFigure);

			fModelReportsCompartmentFigure = new RectangleFigure();

			fModelReportsCompartmentFigure.setOutline(false);

			this.add(fModelReportsCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getModelReportsCompartmentFigure() {
			return fModelReportsCompartmentFigure;
		}
