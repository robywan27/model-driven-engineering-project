 ...
 * @generated
 */
public class ArticleMagazineEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArticleMagazineEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.ArticleMagazineEditPart.VISUAL_ID));
		}
		return parser;
	}
