 ...
 * @generated
 */
public class AdvertisingProductNameType2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AdvertisingProductNameType2EditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.AdvertisingProductNameType2EditPart.VISUAL_ID));
		}
		return parser;
	}
