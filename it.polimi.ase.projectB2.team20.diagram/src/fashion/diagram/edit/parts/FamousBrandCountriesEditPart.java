 ...
 * @generated
 */
public class FamousBrandCountriesEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FamousBrandCountriesEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.FamousBrandCountriesEditPart.VISUAL_ID));
		}
		return parser;
	}
