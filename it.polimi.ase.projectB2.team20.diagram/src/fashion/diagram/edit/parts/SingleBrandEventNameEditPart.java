 ...
 * @generated
 */
public class SingleBrandEventNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SingleBrandEventNameEditPart(View view) {
		super(view);
	}
			...
			parser = FashionParserProvider
					.getParser(
							...
							FashionVisualIDRegistry
									.getType(fashion.diagram.edit.parts.SingleBrandEventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
