 ...
 * @generated
 */
public class FashionDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public FashionDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof FashionDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((FashionDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new FashionDomainNavigatorItem((EObject) objects[i],
