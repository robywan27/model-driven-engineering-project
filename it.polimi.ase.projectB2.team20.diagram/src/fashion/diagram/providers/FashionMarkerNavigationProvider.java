...
import fashion.diagram.part.FashionDiagramEditorUtil;

/**
 * @generated
 */
public class FashionMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = FashionDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			FashionDiagramEditorUtil.selectElementsInDiagram(editor,
