 ...
 * @generated
 */
public class FashionViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return FashionDomainEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = FashionVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = FashionVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!FashionElementTypes.isKnownElementType(elementType)
				...
				if (!FashionDomainEditPart.MODEL_ID
						.equals(FashionVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return BloggerEditPart.VISUAL_ID == visualID
				|| CriticEditPart.VISUAL_ID == visualID
				|| InfluencerEditPart.VISUAL_ID == visualID
				|| FamousBrandEditPart.VISUAL_ID == visualID
				|| EmergingBrandEditPart.VISUAL_ID == visualID
				|| LocalBrandEditPart.VISUAL_ID == visualID
				|| MacroEventEditPart.VISUAL_ID == visualID
				|| SingleBrandEventEditPart.VISUAL_ID == visualID
				|| PhotoEditPart.VISUAL_ID == visualID
				|| DescriptionEditPart.VISUAL_ID == visualID
				|| CommentEditPart.VISUAL_ID == visualID
				|| DesignerEditPart.VISUAL_ID == visualID
				|| ModelEditPart.VISUAL_ID == visualID
				|| PresenterEditPart.VISUAL_ID == visualID
				|| ChoreographerEditPart.VISUAL_ID == visualID
				|| PhotographerEditPart.VISUAL_ID == visualID
				|| AdvertisingCampaignEditPart.VISUAL_ID == visualID
				|| AdvertisingProductEditPart.VISUAL_ID == visualID
				|| ProductLineEditPart.VISUAL_ID == visualID
				|| ProductStyleEditPart.VISUAL_ID == visualID
				|| ProductEditPart.VISUAL_ID == visualID
				|| FashionStyleEditPart.VISUAL_ID == visualID
				|| ArticleEditPart.VISUAL_ID == visualID
				|| TVProgramEditPart.VISUAL_ID == visualID
				|| SingleBrandEvent2EditPart.VISUAL_ID == visualID
				|| AdvertisingProduct2EditPart.VISUAL_ID == visualID
				|| ProductStyle2EditPart.VISUAL_ID == visualID
				|| Product2EditPart.VISUAL_ID == visualID
				|| SpatioTemporalDescriptorEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = FashionVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != FashionVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(FashionDomainEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = FashionVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = FashionVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case BloggerEditPart.VISUAL_ID:
			return createBlogger_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case CriticEditPart.VISUAL_ID:
			return createCritic_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case InfluencerEditPart.VISUAL_ID:
			return createInfluencer_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case FamousBrandEditPart.VISUAL_ID:
			return createFamousBrand_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case EmergingBrandEditPart.VISUAL_ID:
			return createEmergingBrand_2005(domainElement, containerView,
					index, persisted, preferencesHint);
		case LocalBrandEditPart.VISUAL_ID:
			return createLocalBrand_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case MacroEventEditPart.VISUAL_ID:
			return createMacroEvent_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case SingleBrandEventEditPart.VISUAL_ID:
			return createSingleBrandEvent_2008(domainElement, containerView,
					index, persisted, preferencesHint);
		case PhotoEditPart.VISUAL_ID:
			return createPhoto_2009(domainElement, containerView, index,
					persisted, preferencesHint);
		case DescriptionEditPart.VISUAL_ID:
			return createDescription_2010(domainElement, containerView, index,
					persisted, preferencesHint);
		case CommentEditPart.VISUAL_ID:
			return createComment_2011(domainElement, containerView, index,
					persisted, preferencesHint);
		case DesignerEditPart.VISUAL_ID:
			return createDesigner_2012(domainElement, containerView, index,
					persisted, preferencesHint);
		case ModelEditPart.VISUAL_ID:
			return createModel_2013(domainElement, containerView, index,
					persisted, preferencesHint);
		case PresenterEditPart.VISUAL_ID:
			return createPresenter_2014(domainElement, containerView, index,
					persisted, preferencesHint);
		case ChoreographerEditPart.VISUAL_ID:
			return createChoreographer_2015(domainElement, containerView,
					index, persisted, preferencesHint);
		case PhotographerEditPart.VISUAL_ID:
			return createPhotographer_2016(domainElement, containerView, index,
					persisted, preferencesHint);
		case AdvertisingCampaignEditPart.VISUAL_ID:
			return createAdvertisingCampaign_2017(domainElement, containerView,
					index, persisted, preferencesHint);
		case AdvertisingProductEditPart.VISUAL_ID:
			return createAdvertisingProduct_2022(domainElement, containerView,
					index, persisted, preferencesHint);
		case ProductLineEditPart.VISUAL_ID:
			return createProductLine_2018(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProductStyleEditPart.VISUAL_ID:
			return createProductStyle_2019(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProductEditPart.VISUAL_ID:
			return createProduct_2020(domainElement, containerView, index,
					persisted, preferencesHint);
		case FashionStyleEditPart.VISUAL_ID:
			return createFashionStyle_2021(domainElement, containerView, index,
					persisted, preferencesHint);
		case ArticleEditPart.VISUAL_ID:
			return createArticle_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case TVProgramEditPart.VISUAL_ID:
			return createTVProgram_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case SingleBrandEvent2EditPart.VISUAL_ID:
			return createSingleBrandEvent_3005(domainElement, containerView,
					index, persisted, preferencesHint);
		case AdvertisingProduct2EditPart.VISUAL_ID:
			return createAdvertisingProduct_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		case ProductStyle2EditPart.VISUAL_ID:
			return createProductStyle_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		case Product2EditPart.VISUAL_ID:
			return createProduct_3007(domainElement, containerView, index,
					persisted, preferencesHint);
		case SpatioTemporalDescriptorEditPart.VISUAL_ID:
			return createSpatioTemporalDescriptor_3003(domainElement,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (FashionVisualIDRegistry.getVisualID(elementTypeHint)) {
		case FashionElementStylesEditPart.VISUAL_ID:
			return createFashionElementStyles_4001(containerView, index,
					persisted, preferencesHint);
		case NewsReportElementsEditPart.VISUAL_ID:
			return createNewsReportElements_4002(containerView, index,
					persisted, preferencesHint);
		case FashionStyleElementsEditPart.VISUAL_ID:
			return createFashionStyleElements_4003(containerView, index,
					persisted, preferencesHint);
		case BrandCampaignsEditPart.VISUAL_ID:
			return createBrandCampaigns_4004(containerView, index, persisted,
					preferencesHint);
		case BrandProductLinesEditPart.VISUAL_ID:
			return createBrandProductLines_4005(containerView, index,
					persisted, preferencesHint);
		case BrandDesignersEditPart.VISUAL_ID:
			return createBrandDesigners_4006(containerView, index, persisted,
					preferencesHint);
		case AdvertisingCampaignBrandEditPart.VISUAL_ID:
			return createAdvertisingCampaignBrand_4007(containerView, index,
					persisted, preferencesHint);
		case EventRolesEditPart.VISUAL_ID:
			return createEventRoles_4008(containerView, index, persisted,
					preferencesHint);
		case SingleBrandEventBrandEditPart.VISUAL_ID:
			return createSingleBrandEventBrand_4009(containerView, index,
					persisted, preferencesHint);
		case ProductLineBrandEditPart.VISUAL_ID:
			return createProductLineBrand_4010(containerView, index, persisted,
					preferencesHint);
		case ProductReviewsEditPart.VISUAL_ID:
			return createProductReviews_4011(containerView, index, persisted,
					preferencesHint);
		case ReviewProductEditPart.VISUAL_ID:
			return createReviewProduct_4012(containerView, index, persisted,
					preferencesHint);
		case ReviewReviewerEditPart.VISUAL_ID:
			return createReviewReviewer_4013(containerView, index, persisted,
					preferencesHint);
		case RoleEventsEditPart.VISUAL_ID:
			return createRoleEvents_4014(containerView, index, persisted,
					preferencesHint);
		case DesignerBrandEditPart.VISUAL_ID:
			return createDesignerBrand_4015(containerView, index, persisted,
					preferencesHint);
		case ReviewerReviewsEditPart.VISUAL_ID:
			return createReviewerReviews_4016(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createBlogger_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry.getType(BloggerEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createCritic_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry.getType(CriticEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createInfluencer_2003(EObject domainElement,
		...
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createFamousBrand_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createEmergingBrand_2005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createLocalBrand_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createMacroEvent_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createSingleBrandEvent_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createPhoto_2009(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry.getType(PhotoEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createDescription_2010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createComment_2011(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry.getType(CommentEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createDesigner_2012(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry
				.getType(DesignerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5012 = createLabel(node,
				FashionVisualIDRegistry.getType(DesignerNameEditPart.VISUAL_ID));
		createCompartment(
				node,
				FashionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createModel_2013(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry.getType(ModelEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createPresenter_2014(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
	 ...
	 * @generated
	 */
	public Node createChoreographer_2015(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createPhotographer_2016(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createAdvertisingCampaign_2017(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createAdvertisingProduct_2022(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createProductLine_2018(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createProductStyle_2019(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createProduct_2020(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry.getType(ProductEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createFashionStyle_2021(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createArticle_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry.getType(ArticleEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createTVProgram_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createSingleBrandEvent_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createAdvertisingProduct_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createProductStyle_3006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createProduct_3007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FashionVisualIDRegistry
				.getType(Product2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5029 = createLabel(node,
				FashionVisualIDRegistry.getType(ProductName2EditPart.VISUAL_ID));
		createCompartment(
				node,
				FashionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createSpatioTemporalDescriptor_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createFashionElementStyles_4001(View containerView, int index,
		...
		edge.setType(FashionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createNewsReportElements_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createFashionStyleElements_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createBrandCampaigns_4004(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createBrandProductLines_4005(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createBrandDesigners_4006(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createAdvertisingCampaignBrand_4007(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createEventRoles_4008(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createSingleBrandEventBrand_4009(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createProductLineBrand_4010(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createProductReviews_4011(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createReviewProduct_4012(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createReviewReviewer_4013(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createRoleEvents_4014(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createDesignerBrand_4015(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createReviewerReviews_4016(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
