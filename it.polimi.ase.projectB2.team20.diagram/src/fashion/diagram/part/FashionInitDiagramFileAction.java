 ...
 * @generated
 */
public class FashionInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new FashionNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				FashionDomainEditPart.MODEL_ID));
		FashionDiagramEditorUtil.runWizard(getShell(), wizard,
