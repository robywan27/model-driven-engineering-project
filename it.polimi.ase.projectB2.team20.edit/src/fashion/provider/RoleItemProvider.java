...
/**
 * This is the item provider adapter for a {@link fashion.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider extends FashionElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FashionPackage.Literals.ROLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addEventsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_events_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_events_feature", "_UI_Role_type"),
				 FashionPackage.Literals.ROLE__EVENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Role.class)) {
			case FashionPackage.ROLE__NAME:
